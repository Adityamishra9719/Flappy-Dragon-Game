...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'gallery/sprites/dragon.png'
BACKGROUND = 'gallery/sprites/bg2.jpg'
PIPE = 'gallery/sprites/pipe2.png'
...
if __name__ == '__main__':
    ...
    GAME_SPRITES['base'] =pygame.image.load('gallery/sprites/land.png').convert_alpha()
    GAME_SPRITES['pipe'] =(
